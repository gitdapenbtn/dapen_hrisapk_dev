...
class LayoutAppBar extends StatelessWidget implements PreferredSizeWidget {
  ...
  const LayoutAppBar({super.key, this.title, this.bottom, this.action});
  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      padding: EdgeInsets.only(top: safeAreaHeight, left: 20, right: 20),
...
class LayoutAppBarBottom extends StatelessWidget
  ...
  const LayoutAppBarBottom({super.key, this.height, this.child});

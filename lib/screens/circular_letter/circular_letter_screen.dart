...
import 'package:dpbtn_absen/screens/circular_letter/circular_letter_list_screen.dart';
import 'package:flutter/material.dart';
import 'package:dpbtn_absen/layouts/layout.dart';
import 'package:dpbtn_absen/layouts/parts/layout_app_bar.dart';
import 'package:provider/provider.dart';

class CircularLetterScreen extends StatefulWidget {
  const CircularLetterScreen({super.key});

  @override
  State<CircularLetterScreen> createState() => _CircularLetterScreenState();
}

class _CircularLetterScreenState extends State<CircularLetterScreen> {
        ...
        return InkWell(
          onTap: () {
            Navigator.push(
              context,
              MaterialPageRoute(
                builder: (context) => CircularLetterListScreen(

...
import 'package:dpbtn_absen/screens/decision_letter/decision_letter_list_screen.dart';
import 'package:flutter/material.dart';
import 'package:dpbtn_absen/layouts/layout.dart';
import 'package:dpbtn_absen/layouts/parts/layout_app_bar.dart';
import 'package:provider/provider.dart';

class DecisionLetterScreen extends StatefulWidget {
  const DecisionLetterScreen({super.key});

  @override
  State<DecisionLetterScreen> createState() => _DecisionLetterScreenState();
}

class _DecisionLetterScreenState extends State<DecisionLetterScreen> {
        ...
        return InkWell(
          onTap: () {
            Navigator.push(
              context,
              MaterialPageRoute(
                builder: (context) => DecisionLetterListScreen(

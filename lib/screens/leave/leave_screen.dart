...
import 'package:dpbtn_absen/screens/leave/leave_detail_screen.dart';
import 'package:dpbtn_absen/screens/leave/leave_form_screen.dart';
...
class _LeaveScreenState extends State<LeaveScreen> {
  ...
  Widget build(BuildContext context) {
    return Layout(
      ...
      child: _listView(_leaveProvider.leaves),
    );
  }

  Widget _listView(List<LeaveModel> leaves) {
